...
@section('page-header') 
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الأفسام</span>
						</div>
					</div>
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
												...
												<th class="border-bottom-0">إسم الفسم</th>
						...
						<div class="modal-content modal-content-demo">
							...
							<div class="modal-body">
									<div class="form-group">
										<label for="section">إسم القسم</label>
										<input class="form-control" type="text" name="section_name" id="section">
									</div>
									<div class="form-group">
