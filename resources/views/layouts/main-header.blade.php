								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<a href="{{route('mark')}} " class="badge badge-pill badge-warning mr-auto my-auto float-left">تعيين قراءة الكل </a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الإشعارات الغير مقروءه:<h6 style="color: yellow" id="notifications_count"> {{ auth()->user()->unreadNotifications->count() }}</h6> 
										</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										...
										{{-- @for ($i = 0; $i < auth()->user()->unreadNotifications; $i++) --}}
