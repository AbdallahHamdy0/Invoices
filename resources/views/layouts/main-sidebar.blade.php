<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/invoice.png')}}" class="main-logo" alt="logo"></a>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@endcan
							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='Archive') }}">أرشيف فواتير</a></li>
							@endcan
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@endcan
							{{-- <li><a class="slide-item" href="{{ url('/' . $page='rangeslider') }}"></a></li> --}}
